...
I would like to predict birth weight (bwt) based on a combination of maternal and pregnancy-related factors. The model uses hypothesized predictors informed by my prior knowledge in maternal health. I include smoken, ppbmi, ppwt, wtgain, gaweeks as predictors.
