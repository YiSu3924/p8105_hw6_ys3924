...
The above plot indicates that the model explains approximately 88% to 94% of the variance, with a peak around 91%.
...
The above plot shows that the values are concentrated between 1.95 and 2.10, with a peak near 2.02. The product of the coefficients remains stable across bootstrap samples, which reflects consistent model performance.
